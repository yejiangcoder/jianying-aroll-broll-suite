...
Write-Host "MODE=PHASE_4E_FULL_AROLL_GATED_WRITE"
...
Write-Host "DEFAULT_NO_DEEPSEEK=1"
Write-Host "FULL_DRY_RUN_GATE_BEFORE_WRITE=1"
...
$ArgsList = @(
  (Join-Path $PSScriptRoot "src\aroll_phase4e_full_aroll.py"),
  "--draft-dir", $DraftDir,
