...
class ArollV21StaticHiddenBugScanTests(unittest.TestCase):
    ...
    def test_high_risk_patterns_are_allowlisted(self) -> None:
        allowed_except_files = {
            ...
            "src/aroll_v21/ready_run_reuse.py",
            "src/aroll_v21/semantic_provider_factory.py",
            ...
            "src/aroll_v21/writeback/snapshot_guard.py",
        }
        allowed_return_empty = {
            "src/aroll_v21/operator.py",
            "src/aroll_v21/operator_io.py",
            "src/aroll_v21/ready_run_reuse.py",
            "src/aroll_v21/decision/local_policy.py",
            "src/aroll_v21/decision/semantic_decision_planner.py",
            "src/aroll_v21/decision/semantic_json_planner.py",
            "src/aroll_v21/decision/unit_split_binding.py",
            ...
            "src/aroll_v21/writeback/real_draft_writeback.py",
            "src/aroll_v21/writeback/actual_timeline_audit.py",
            "src/aroll_v21/writeback/source_segment_template_resolver.py",
            "src/aroll_v21/writeback/speed_resolver.py",
            "src/aroll_v21/writeback/track_selector.py",
            "src/aroll_v21/writeback/video_projection.py",
            "src/aroll_v21/writeback/writeback_time_utils.py",
            "src/aroll_v21/compiler/boundary_cleanup.py",
            "src/aroll_v21/compiler/final_timeline_compiler.py",
            "src/aroll_v21/compiler/modifier_semantic_pass.py",
            "src/aroll_v21/compiler/suffix_cleanup.py",
            "src/aroll_v21/engine_validation.py",
            "src/aroll_v21/quality/final_visible_repair/rules/caption_only_merge.py",
            "src/aroll_v21/quality/final_visible_repair/rules/connector_intrusion.py",
            "src/aroll_v21/quality/final_visible_repair/rules/de_shi_bridge.py",
            "src/aroll_v21/quality/final_visible_repair/rules/leading_filler.py",
            "src/aroll_v21/quality/final_visible_repair/rules/pre_visible_semantic_junk.py",
            "src/aroll_v21/quality/final_visible_repair/rules/restart_repeat.py",
        ...
        allowed_success_assignments = {
            ...
            "src/aroll_v21/operator.py",
            "src/aroll_v21/operator_summary.py",
