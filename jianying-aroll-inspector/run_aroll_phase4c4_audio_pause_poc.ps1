param(
  ...
  [string]$PreviousDir = "D:\video tools\jianying-aroll-inspector\runtime\aroll_phase4c3_sentence_gap_poc_20260614_182707",
...
Write-Host "MODE=PHASE_4C4_POSTWRITE_AUDIO_PAUSE_POC"
...
$ArgsList = @(
  (Join-Path $PSScriptRoot "src\aroll_phase4c4_audio_pause_poc.py"),
  "--draft-dir", $DraftDir,
