...
Write-Host "MODE=PHASE_4D2_REPAIRED_75S_TEST"
...
Write-Host "SPLIT_VIDEO_EDL_AND_DISPLAY_SUBTITLE_PLAN=1"
Write-Host "BLOCK_ON_OVERLONG_OR_SINGLE_CHAR_SUBTITLE=1"
...
$ArgsList = @(
  (Join-Path $PSScriptRoot "src\aroll_phase4d2_75s_test.py"),
  "--draft-dir", $DraftDir,
