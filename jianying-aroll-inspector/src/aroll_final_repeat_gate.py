...
def build_final_repeat_gate_report(
    ...
    *,
    ...
    report = {
        ...
        "final_repeat_gate_passed": (text_high + text_medium + semantic_high + hidden_high + target_high + target_medium) == 0,
        "blocking_issues": issues[:100] if (text_high + text_medium + semantic_high + hidden_high) else [],
